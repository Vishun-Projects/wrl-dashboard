...
import { ShieldAlert, ShieldCheck, PhoneCall, AlertTriangle } from 'lucide-react';
...
export function WarrantyComparisonKpiCards({ summary, loading }: KpiProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-2 px-3 py-1.5 sm:grid-cols-4 lg:grid-cols-4">
      ...
      <div className="rounded-lg border border-rose-400 bg-white px-2.5 py-1.5 shadow-2xs">
        <div className="flex items-center justify-between text-[11px] text-slate-500 font-medium">
      ...
      <div className="rounded-lg border border-amber-400 bg-white px-2.5 py-1.5 shadow-2xs">
        <div className="flex items-center justify-between text-[11px] text-slate-500 font-medium">
      ...
      <div className="rounded-lg border border-indigo-400 bg-white px-2.5 py-1.5 shadow-2xs">
        <div className="flex items-center justify-between text-[11px] text-slate-500 font-medium">
