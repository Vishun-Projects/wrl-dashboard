...
import { BdMisSummaryPanel } from '@/modules/mis/components/BdMisSummaryPanel';
import type { BdMisGrandRow, BdMisRegionalRow } from '@/modules/mis/services/bd-mis-summary';
