...
import type { RegisterMultiSelectOption } from '@/modules/mis/register/services/multi-select-types';

export type { RegisterMultiSelectOption } from '@/modules/mis/register/services/multi-select-types';
