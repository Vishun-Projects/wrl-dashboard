...
import { loadBatchFileBytes } from '@/modules/mis/client-import/services/batch-file';
import { absoluteFromStoredPath } from '@/modules/mis/client-import/services/file-store';
...
export async function resolveMisBatchDownload(params: {
  ...
  if (meta.stored_file_path) {
    const absolutePath = absoluteFromStoredPath(meta.stored_file_path);
    try {
