import { buildDigestAttachments, resolveDigestAttachmentFilenames, type EmailAttachment } from '@/modules/mail-alerts/services/build-attachments';
import {
...
} from '@/modules/mail-alerts/services/fetch-digest-data';
import {
  fetchDigestClientAccountSummaryCached,
  fetchDigestSummaryDataCached,
} from '@/modules/mail-alerts/services/digest-cache';
import {
...
} from '@/modules/mail-alerts/services/email-template';
import {
...
import { resolvePortalUrl, sendPreparedDigestEmail } from '@/modules/mail-alerts/services/send';
...
import { resolveUserDigestScopeWithLabel } from '@/modules/mail-alerts/services/user-scope';
import { formatBytes, MisEmailTimer, type MisEmailTimingReport } from '@/modules/mail-alerts/services/timing';
import {
  gmailClipWarningMessage,
  measureHtmlUtf8Bytes,
} from '@/modules/mail-alerts/services/email-html-size';
import type { MisEmailBodyLayout } from '@/modules/mail-alerts/services/email-body-layout';
import type { MisEmailBodySectionId } from '@/modules/mail-alerts/services/body-sections';
