import type { EmailAttachment } from '@/modules/mail-alerts/services/build-attachments';
import {
...
} from '@/modules/mail-alerts/services/org-settings';
import {
  isMisEmailRelayConfigured,
  sendPreparedMisEmailViaVpsRelay,
} from '@/modules/mail-alerts/services/send-relay';
