...
vi.mock('@/modules/mail-alerts/services/user-scope', () => ({
...
vi.mock('@/modules/mail-alerts/services/digest-cache', () => ({
...
vi.mock('@/modules/mail-alerts/services/fetch-digest-data', () => ({
  fetchDigestRegisterRows: (...args: unknown[]) => fetchDigestRegisterRows(...args),
}));

vi.mock('@/modules/mail-alerts/services/build-attachments', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/modules/mail-alerts/services/build-attachments')>();
  return {
    ...actual,
...
vi.mock('@/modules/mail-alerts/services/fetch-digest-trace', () => ({
...
} = await import('@/modules/mail-alerts/services/compose-digest');
