...
} from '@/modules/mail-alerts/services/default-recipients';
import { assertAllowedEmailDomains } from '@/modules/mail-alerts/services/allowed-domains';
...
export type { MisEmailBodyLayout } from '@/modules/mail-alerts/services/email-body-layout';
