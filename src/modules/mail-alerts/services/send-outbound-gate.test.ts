...
vi.mock('@/modules/mail-alerts/services/send-relay', () => ({
...
import { assertOrgOutboundMailEnabled } from '@/modules/mail-alerts/services/org-settings';
import { sendPreparedDigestEmail } from '@/modules/mail-alerts/services/send';
