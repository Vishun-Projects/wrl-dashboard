...
import type { RegisterMultiSelectOption } from '@/features/register/services/multi-select-types';

export type { RegisterMultiSelectOption } from '@/features/register/services/multi-select-types';
