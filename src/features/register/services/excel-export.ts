...
import { blobToPreparedExport, triggerBlobDownload } from '@/features/report/download';
import { formatRegisterExportDate } from '@/features/register/services/register-export-format';
import { formatRegisterMajorMinor } from '@/features/register/services/register-export-format';
import { formatRegisterRepairDone } from '@/features/register/services/register-export-format';
...
): Promise<import('@/features/report/services/summary-excel-export').PreparedFileExport> {
  const rows = normalizeRegisterExportRows(rawRows);
  if (!rows.length) {
