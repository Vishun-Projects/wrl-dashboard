...
vi.mock('@/features/mis-email/lib/send-relay', () => ({
...
import { assertOrgOutboundMailEnabled } from '@/features/mis-email/lib/org-settings';
import { sendPreparedDigestEmail } from '@/features/mis-email/lib/send';
