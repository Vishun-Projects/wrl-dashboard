...
import { runMisEmailDigest, runMisEmailTestBatch } from '@/features/mis-email/lib/run-digest';
...
async function main(): Promise<void> {
  ...
  try {
    switch (command) {
      ...
      default:
        console.log(`Usage:
  npx tsx src/features/mis-email/lib/cli.ts digest
  npx tsx src/features/mis-email/lib/cli.ts test [--user=<uuid>] [--to=a@x.com,b@y.com] [--cc=c@z.com]
  npx tsx src/features/mis-email/lib/cli.ts send-user   (MIS_EMAIL_SEND_PAYLOAD=base64 json)
