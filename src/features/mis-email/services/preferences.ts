...
import { DEFAULT_ALLOWED_EMAIL_DOMAINS } from '@/features/mis-email/services/org-settings-defaults';

export type { MisEmailBodyLayout } from '@/features/mis-email/services/email-body-layout';
