import { buildDigestAttachments, resolveDigestAttachmentFilenames, type EmailAttachment } from '@/features/mis-email/services/build-attachments';
import {
...
} from '@/features/mis-email/services/body-sections';
import {
...
} from '@/features/mis-email/services/mail-basis';
import { buildDigestTraceableExportPayload } from '@/features/mis-email/services/fetch-digest-trace';
import {
  fetchDigestRegisterRows,
  type DigestDateRange,
} from '@/features/mis-email/services/fetch-digest-data';
import {
  fetchDigestClientAccountSummaryCached,
  fetchDigestSummaryDataCached,
} from '@/features/mis-email/services/digest-cache';
import {
...
} from '@/features/mis-email/services/email-template';
import {
...
import { resolvePortalUrl, sendPreparedDigestEmail } from '@/features/mis-email/services/send';
...
import { formatBytes, MisEmailTimer, type MisEmailTimingReport } from '@/features/mis-email/services/timing';
import {
  gmailClipWarningMessage,
  measureHtmlUtf8Bytes,
} from '@/features/mis-email/services/email-html-size';
import type { MisEmailBodyLayout } from '@/features/mis-email/services/email-body-layout';
