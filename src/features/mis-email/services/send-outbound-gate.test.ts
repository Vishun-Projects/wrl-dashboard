...
vi.mock('@/features/mis-email/services/send-relay', () => ({
...
import { assertOrgOutboundMailEnabled } from '@/features/mis-email/services/org-settings';
import { sendPreparedDigestEmail } from '@/features/mis-email/services/send';
