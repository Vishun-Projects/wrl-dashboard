...
import { runMisEmailDigest, runMisEmailTestBatch } from '@/features/mis-email/services/run-digest';
...
async function main(): Promise<void> {
  ...
  try {
    switch (command) {
      ...
      default:
        console.log(`Usage:
  npx tsx src/features/mis-email/services/cli.ts digest
  npx tsx src/features/mis-email/services/cli.ts test [--user=<uuid>] [--to=a@x.com,b@y.com] [--cc=c@z.com]
  npx tsx src/features/mis-email/services/cli.ts send-user   (MIS_EMAIL_SEND_PAYLOAD=base64 json)
