/** Default Zonal Heads distribution for profile Email reports. */

export const DEFAULT_MIS_EMAIL_TO_EMAILS: string[] = [
...
export const DEFAULT_MIS_EMAIL_CC_EMAILS: string[] = [
