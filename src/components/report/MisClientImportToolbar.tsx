          ...
          <table className="w-full min-w-[640px] text-left text-[10px]">
            <thead className="sticky top-0 z-10 bg-slate-100 text-slate-600">
              <tr>
                ...
                {canUpload && <th className="p-1.5 w-16" />}
              </tr>
            </thead>
            <tbody>
                        ...
                        <div className="flex items-center gap-0.5">
                          {batch.storedFilePath && (
                            <button
                              ...
                              onClick={() =>
                                void handleDownloadBatch(batch.batchId, batch.fileName)
                              }
                              className="rounded p-0.5 text-indigo-600 hover:bg-indigo-50 disabled:opacity-50"
                            >
                          ...
                          <button
                            ...
                            className="rounded p-0.5 text-rose-600 hover:bg-rose-50 disabled:opacity-50"
                          >
