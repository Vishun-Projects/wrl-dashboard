...
} from '@/modules/warranty-master/services/constants';
import type { WarrantyMasterQueryParams } from '@/modules/warranty-master/services/types';
...
/** Corpus: not returned + has customer/party. activeOnly = warranty end ≥ today. */
