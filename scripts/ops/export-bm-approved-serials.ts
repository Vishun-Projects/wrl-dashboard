 ...
 *
 * Usage:
 *   npx tsx scripts/ops/export-bm-approved-serials.ts [startDate] [endDate] [franchiseeNcode]
 *
 * Example (Abhijeet Refrigeration, April 2026):
 *   npx tsx scripts/ops/export-bm-approved-serials.ts 2026-04-01 2026-04-30 152
 *
 * Writes:
...
import { queryArcpClaimsDetailRows } from '../src/sql/arcp-claims/postgres';
import {
  buildArcpClaimsFilterCondition,
  splitArcpDateRange,
  type ArcpClaimsDetailRow,
} from '../src/sql/arcp-claims/query';
