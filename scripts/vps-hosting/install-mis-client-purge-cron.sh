...
ssh "$VPS_HOST" "mkdir -p '${INSTALL_ROOT}/scripts/vps-hosting' '${INSTALL_ROOT}/scripts/mis-client' '${INSTALL_ROOT}/src/modules/mis/client-import/services' '${INSTALL_ROOT}/logs'"
...
scp \
  "${ROOT}/src/modules/mis/client-import/services/purge-old-files.ts" \
  "${ROOT}/src/modules/mis/client-import/services/file-store.ts" \
  "${VPS_HOST}:${INSTALL_ROOT}/src/modules/mis/client-import/services/"
scp \
  "${ROOT}/src/modules/mis/client-import/server.ts" \
  "${VPS_HOST}:${INSTALL_ROOT}/src/modules/mis/client-import/server.ts"
