...
if [[ ! -f "${INSTALL_ROOT}/src/modules/mis-email/services/cli.ts" ]]; then
  echo "FATAL: missing ${INSTALL_ROOT}/src/modules/mis-email/services/cli.ts — deploy modules first" >&2
  exit 1
fi
