 ...
 *
 *   npx tsx scripts/audit-read-model-full.ts              # report only
 *   npx tsx scripts/audit-read-model-full.ts --apply      # fix drift from CRM
 *   npx tsx scripts/audit-read-model-full.ts --only hot,dims,facts
 *   npx tsx scripts/audit-read-model-full.ts --resume-from-trn 26F01029
 *   npx tsx scripts/audit-read-model-full.ts --skip-reverse
 *
