 ...
 *
 * Usage:
 *   node scripts/analyze-performance-log.mjs
 *   node scripts/analyze-performance-log.mjs --date 2026-06-12
 *   node scripts/analyze-performance-log.mjs --file logs/performance/metrics-2026-06-12.jsonl
 */
